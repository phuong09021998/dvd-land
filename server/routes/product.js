...
const { getProductById, productById, createProduct, deleteProduct, updateProduct, listProduct, productBySearch, listGenre, getPhoto, listCountries, getHotSales } = require('../controllers/product')
