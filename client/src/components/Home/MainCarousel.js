    ...
    return (
        <Carousel autoplay className="carousel_home">
            <div className="carousel_item">
                ...
                <Link to="/product/5e718a7eb18d2e114877b993"><button className="button_carousel">Shop now</button></Link>
                
            </div>
            <div className="carousel_item">
                <img src={IPMan4} className="img_carousel"/>
                <Link to="/product/5e718ed6749e741e04f94166"><button className="button_carousel">Shop now</button></Link>
                
            </div>
            <div className="carousel_item">
                <img src={Parasite} className="img_carousel"/>
                <Link to="/product/5e718e3860a9412b7ca6429c"><button className="button_carousel">Shop now</button></Link>
            </div>
        </Carousel>
    )
}
